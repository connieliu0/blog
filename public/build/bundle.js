    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			a.textContent = "here";
    			t41 = text("!");
    			attr_dev(div0, "class", "column-content svelte-1jvhe4");
    			add_location(div0, file, 93, 4, 2171);
    			attr_dev(div1, "class", "column svelte-1jvhe4");
    			add_location(div1, file, 92, 2, 2146);
    			set_style(p0, "color", "gray");
    			attr_dev(p0, "class", "svelte-1jvhe4");
    			add_location(p0, file, 98, 8, 2288);
    			attr_dev(div2, "class", "column-content svelte-1jvhe4");
    			add_location(div2, file, 97, 6, 2251);
    			attr_dev(div3, "class", "column svelte-1jvhe4");
    			add_location(div3, file, 96, 4, 2224);
    			attr_dev(div4, "class", "column-content svelte-1jvhe4");
    			add_location(div4, file, 114, 6, 3076);
    			attr_dev(div5, "class", "column svelte-1jvhe4");
    			add_location(div5, file, 113, 4, 3049);
    			attr_dev(div6, "class", "column-content svelte-1jvhe4");
    			add_location(div6, file, 126, 6, 3553);
    			attr_dev(div7, "class", "column svelte-1jvhe4");
    			add_location(div7, file, 125, 4, 3526);
    			attr_dev(div8, "class", "column-content svelte-1jvhe4");
    			add_location(div8, file, 139, 6, 4163);
    			attr_dev(div9, "class", "column svelte-1jvhe4");
    			add_location(div9, file, 138, 4, 4136);
    			attr_dev(div10, "class", "column-content svelte-1jvhe4");
    			add_location(div10, file, 157, 6, 5403);
    			attr_dev(div11, "class", "column svelte-1jvhe4");
    			add_location(div11, file, 156, 4, 5376);
    			attr_dev(div12, "class", "column-content svelte-1jvhe4");
    			add_location(div12, file, 170, 6, 5944);
    			attr_dev(div13, "class", "column svelte-1jvhe4");
    			add_location(div13, file, 169, 4, 5917);
    			attr_dev(div14, "class", "column-content svelte-1jvhe4");
    			add_location(div14, file, 182, 6, 6535);
    			attr_dev(div15, "class", "column svelte-1jvhe4");
    			add_location(div15, file, 181, 4, 6508);
    			attr_dev(div16, "class", "column-content svelte-1jvhe4");
    			add_location(div16, file, 194, 6, 7371);
    			attr_dev(div17, "class", "column svelte-1jvhe4");
    			add_location(div17, file, 193, 4, 7344);
    			attr_dev(div18, "class", "column-content svelte-1jvhe4");
    			add_location(div18, file, 206, 6, 8059);
    			attr_dev(div19, "class", "column svelte-1jvhe4");
    			add_location(div19, file, 205, 4, 8032);
    			attr_dev(div20, "class", "column-content svelte-1jvhe4");
    			add_location(div20, file, 217, 6, 8570);
    			attr_dev(div21, "class", "column svelte-1jvhe4");
    			add_location(div21, file, 216, 4, 8543);
    			attr_dev(div22, "class", "column-content svelte-1jvhe4");
    			add_location(div22, file, 228, 6, 9000);
    			attr_dev(div23, "class", "column svelte-1jvhe4");
    			add_location(div23, file, 227, 4, 8973);
    			attr_dev(div24, "class", "column-content svelte-1jvhe4");
    			add_location(div24, file, 240, 6, 9520);
    			attr_dev(div25, "class", "column svelte-1jvhe4");
    			add_location(div25, file, 239, 4, 9493);
    			attr_dev(a, "href", "https://corny.substack.com");
    			add_location(a, file, 262, 62, 10739);
    			attr_dev(p1, "class", "svelte-1jvhe4");
    			add_location(p1, file, 261, 8, 10673);
    			attr_dev(div26, "class", "column-content svelte-1jvhe4");
    			add_location(div26, file, 260, 6, 10636);
    			attr_dev(div27, "class", "column svelte-1jvhe4");
    			add_location(div27, file, 259, 4, 10609);
    			attr_dev(div28, "class", "content-container svelte-1jvhe4");
    			add_location(div28, file, 88, 2, 2074);
    			attr_dev(div29, "class", "scroll-container svelte-1jvhe4");
    			add_location(div29, file, 86, 0, 2000);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
